...
| [chunk Sidecars (inner-loop AI validation)](guides/chunk-sidecars.md) | Per-agent inner-loop validation that mirrors CI via CircleCI sidecars: commit/stop gates, WSL dispatch on Windows, snapshots. |
